...
'//documentjs/json', '//documentjs/baseclass', '//documentjs/showdown').then(function( $ ) {
...
}).then('//documentjs/distance', '//documentjs/application', '//documentjs/tags/tags', '//documentjs/types/types')