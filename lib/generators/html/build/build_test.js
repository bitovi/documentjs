...
describe("documentjs/lib/build",function(){
	
	it("get_renderer and get_partial work",function(done){
		Q.all([
			getRenderer('documentjs/lib/build/test/templates'),
			getPartials('documentjs/lib/build/test/templates')
	...
	it.only("build.renderer build.templates build.helpers",function(done){
		var options = {
