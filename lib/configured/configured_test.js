...
describe("lib/configured", function(){
	...
	it.only(".geneateProject is able to read the documentjs.json without versions and build a site", function(done){
		this.timeout(10000);
		rmdir(path.join(__dirname,"test","api"), function(e){
			...
			configured.generateProject({path: __dirname+"/test/example_project", debug: true}).then(function(){
