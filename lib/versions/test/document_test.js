...
describe("versions/document", function(){
	...
	it("is able to read the documentjs.json without versions and build a site", function(done){
		...
		rmdir(path.join(__dirname,"api"), function(e){
			...
			documentVersion({path: __dirname+"/example_project"}).then(function(){
	...
	it("is able to document multiple versions", function(done){
		...
		rmdir(path.join(__dirname,"tmp","multiple_versions"), function(e){
			...
			documentVersion({path: __dirname+"/multiple_versions"}).then(function(){
				check1(function(){
					check2(function(){
						check3(done, done);
					}, done);
